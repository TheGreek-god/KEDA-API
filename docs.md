...
```bash
curl http://localhost:4000/my-identity
```
...
make apply # deploy myidentity-api and expose service
```
...
# deploy myidentity-api and expose service
...
```bash
curl 10.98.55.109:4000/my-identity # replace ip address
```
